...
import { ArrowRight, CheckCircle2, TrendingUp, Target, Users, Quote } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Remplissez votre agenda grâce à des campagnes Facebook & Instagram pensées pour les praticiens bien-être. Résultats mesurables.",
...
const solutions = [
  ...
  },
  {
    ...
    desc: "Votre page de destination transformée pour convertir les visiteurs en clients (systeme.io, WordPress).",
  },
  {
    icon: Users,
    title: "Expertise secteur bien-être",
    desc: "J'accompagne exclusivement les praticiens bien-être. Naturopathie, coaching, réflexologie — votre univers est le mien.",
  },
];
...
export default function HomePage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            name: "Thibaut Gervy — Meta Ads pour Naturopathes & Thérapeutes",
            description:
              "Spécialiste Meta Ads et optimisation de conversion pour praticiens bien-être. Remplissez votre agenda.",
            url: "https://thibautgervy.fr",
            breadcrumb: {
              "@type": "BreadcrumbList",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Accueil", item: "https://thibautgervy.fr" },
              ],
            },
          }),
        }}
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Marketing digital bien-être — Thibaut Gervy Meta Ads"
            fill
            priority
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full border border-gold/5 animate-pulse" />
        <div className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full border border-gold/8" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-20">
          <div className="max-w-3xl">
            ...
            <AnimatedSection delay={0.1}>
              {/* H1 optimisé SEO avec mots-clés naturels */}
              <h1
            ...
            <AnimatedSection delay={0.2}>
              <p className="text-cream-muted text-lg md:text-xl leading-relaxed mb-4 max-w-xl">
                J'aide les <strong className="text-cream font-medium">naturopathes, coachs et thérapeutes</strong> à remplir leur
                agenda grâce à des stratégies <strong className="text-cream font-medium">Meta Ads</strong> pensées pour leur
                secteur.
              </p>
              <p className="text-cream-muted text-base leading-relaxed mb-10 max-w-xl">
                Pas de solution générique. Pas de résultats aléatoires. Un <strong className="text-cream font-medium">tunnel de conversion</strong> optimisé et des campagnes qui performent.
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <div className="flex flex-wrap gap-8 mt-14 pt-10 border-t border-dark-border">
                {[
                  ...
                  <div key={stat.label}>
                    <p className="font-display text-3xl text-gold mb-1" style={{ fontFamily: "var(--font-display)" }}>
                      {stat.value}
                    </p>
      ...
      {/* ════════ PROBLÈME ════════ */}
      <section className="section-padding bg-dark-surface" aria-label="Problèmes courants des praticiens bien-être">
            ...
            <div>
              <AnimatedSection direction="left">
                ...
                <p className="text-cream-muted text-base leading-relaxed mb-8">
                  ...
                  agenda. Dans un monde numérique saturé de messages, la
                  visibilité ne s'improvise plus. Ça, je le sais — et c'est
            ...
            <AnimatedSection direction="right" className="relative">
              <div className="relative rounded-sm overflow-hidden aspect-[4/3]">
                <Image
                  ...
                  alt="Praticien bien-être cherchant à développer sa clientèle via le marketing digital"
                  fill
      ...
      {/* ════════ SOLUTION ════════ */}
      <section className="section-padding" aria-label="Solutions Meta Ads pour praticiens bien-être">
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <span className="gold-line mx-auto mb-5" style={{ margin: "0 auto 20px" }} />
            <h2
              className="font-display text-4xl md:text-5xl text-cream mb-4"
              style={{ fontFamily: "var(--font-display)" }}
            >
              La solution, <em className="text-gold">c'est la spécialité</em>
            </h2>
            <p className="text-cream-muted max-w-xl mx-auto text-base">
              Je ne travaille qu'avec des praticiens bien-être. Naturopathes, coachs, réflexologues, thérapeutes — votre secteur est ma spécialité.
            </p>
          </AnimatedSection>
